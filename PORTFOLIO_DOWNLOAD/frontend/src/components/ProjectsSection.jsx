                ...
                <CardHeader>
                  <div className="flex items-start justify-between mb-2">
                    <div className="flex-1">
                      <CardTitle className="text-2xl font-bold text-[#00d4ff] mb-2" style={{ fontFamily: 'Orbitron, sans-serif' }}>
                        {project.name}
                      </CardTitle>
                      <div className="flex items-center gap-3 text-sm text-gray-400">
                        <div className="flex items-center gap-1">
                          <div
                            ...
                            style={{
                              backgroundColor: languageColors[project.language] || '#00d4ff',
                              boxShadow: `0 0 10px ${languageColors[project.language] || '#00d4ff'}`
                            }}
                          />
                    ...
                    <a
                      ...
                      className="p-2 glass glow-border rounded-lg hover:bg-[#00d4ff]/10 smooth-transition"
                    >
                      <Github className="w-5 h-5 text-[#00d4ff]" />
                    </a>
                  </div>
                </CardHeader>
                <CardContent>
