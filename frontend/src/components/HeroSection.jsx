...
const HeroSection = ({ personalInfo }) => {
  ...
  const stats = [
    { icon: Code, label: 'Experience', value: personalInfo.experience, color: '#38bdf8' },
    { icon: Database, label: 'Role', value: 'QA Engineer', color: '#7dd3fc' },
    { icon: Zap, label: 'Focus', value: 'Driver Testing', color: '#0ea5e9' }
  ];
    ...
    >
      ...
      <div className="max-w-5xl mx-auto text-center relative z-10">
        ...
        >
          {text}
          <motion.span 
            className="inline-block w-1 h-16 bg-sky-400 ml-2"
        ...
        <motion.p
          className="text-xl md:text-2xl text-sky-400 mb-4 font-semibold"
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
