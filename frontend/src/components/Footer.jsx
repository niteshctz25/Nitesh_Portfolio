    ...
    <footer className="relative py-12 px-4 border-t border-gray-800 bg-gray-950">
      <div className="max-w-7xl mx-auto">
        <div className="grid md:grid-cols-3 gap-8 mb-8">
          ...
          {/* Connect */}
          <div>
            <h4 className="text-lg font-semibold text-gray-100 mb-4">Connect</h4>
            
            <motion.a
              href={personalInfo.resumeLink}
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-2 bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded-lg text-sm font-semibold mb-4 transition-all duration-300"
