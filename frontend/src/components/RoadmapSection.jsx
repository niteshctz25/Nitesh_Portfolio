    ...
    <section id="roadmap" className="py-20 px-4 relative overflow-hidden jarvis-bg">
      <div className="max-w-6xl mx-auto relative z-10">
        ...
        <div className="relative">
          {/* Timeline Line */}
          <div className="absolute left-8 md:left-1/2 top-0 bottom-0 w-0.5 bg-gradient-to-b from-transparent via-[#0099cc] to-transparent transform md:-translate-x-1/2" />
              ...
              return (
                ...
                >
                  ...
                  <div className={`w-full md:w-5/12 ml-16 md:ml-0 ${
                    ...
                    >
                      <div className="flex items-center gap-3 mb-3">
                        {Icon && (
                          <div className="p-2 rounded-lg bg-[#0099cc]/10 glow-border">
                            <Icon className="w-5 h-5 text-[#0099cc]" />
                          </div>
                        )}
                        <span className="text-2xl font-bold text-[#0099cc]" style={{ fontFamily: 'Orbitron, sans-serif' }}>
                          {event.year}
                        </span>
                      </div>
                  ...
                  <div className="absolute left-8 md:left-1/2 transform md:-translate-x-1/2 flex items-center justify-center">
                    <motion.div
                      className="w-4 h-4 rounded-full bg-[#0099cc] z-10"
                      style={{
                    ...
                    >
                      <div className="absolute inset-0 rounded-full bg-[#0099cc] animate-ping opacity-75" />
                    </motion.div>
                  </div>
                </motion.div>
              );
